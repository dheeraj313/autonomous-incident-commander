...
public class FaultInjectionService {
    ...
    private static final String LATENCY_KEY = "fault-injection:notifications-service:latency-ms";
    private static final String ERROR_RATE_KEY = "fault-injection:notifications-service:error-rate";
    ...
    public void apply() {
        ...
        if (errorRate > 0 && Math.random() < errorRate) {
            throw new InjectedFaultException("Injected fault in notifications-service");
        }
    }
}
